 ...
 */
$messages['ba'] = array(
	'absenteelandlord-reason' => 'Мәғлүмәттәр базаһы хакимдәрҙең әүҙемһеҙлеге арҡаһында үҙенән-үҙе бикләнгән.',
	'absenteelandlord-desc' => 'Әгәр хакимдәрҙең береһе лә ниндәйҙер ваҡыт арауығында әүҙемлек күрһәмтәһәләр, вики проекттың мәғлүмәттәр базаһын үҙенән-үҙе  бикләй',
);
...
$messages['bn'] = array(
	...
	'absenteelandlord-desc' => 'উইকিডাটাবেজ সংয়ক্রিয়ভাবে বন্ধ করে যদি সব প্রশাসকেরা কিছু সময়ের জন্য নিষ্ক্রিয় থাকেন।',
);
...
$messages['ja'] = array(
	...
	'absenteelandlord-desc' => 'すべての管理者が一定期間活動しない場合、ウィキのデータベースを自動的にロックする',
);
 ...
 */
$messages['mr'] = array(
	'absenteelandlord-reason' => 'प्रबंधकांच्या निष्क्रियतेमुळे,विदागाराला आपोआप कुलूप लावण्यात आलेले आहे.',
	'absenteelandlord-desc' => 'प्रबंधकांकडून काही काळासाठी कुठलीही क्रिया न झाल्यास विदागाराला आपोआप कुलूप घालतो',
);
...
$messages['or'] = array(
	...
	'absenteelandlord-desc' => 'ଯଦି ପରିଚାଳକଗଣ କିଛି ସମୟ ପାଇଁ କାମ ନକରନ୍ତି ତେବେ ସ୍ଵଃଚାଳିତ ରୂପେ ଉଇକି ଡ଼ାଟାବେସକୁ ତାଲା ଲଗାନ୍ତୁ',
);
 ...
 */
$messages['pfl'] = array(
	'absenteelandlord-reason' => 'De Daadebschdond isch fa alle gschberd worre, wail alli Adminischradore grad kä Luschd kabd hawen.',
 ...
 */
$messages['rue'] = array(
	'absenteelandlord-reason' => 'Датабаза была автоматічно заблокована про неактівность адміністраторів.',
	'absenteelandlord-desc' => 'Автоматічно блокує датабазу вікі-проєкту, кідь жаден з адміністраторів не проявлює актівность даякый час',
);
...
$messages['yi'] = array(
	...
	'absenteelandlord-desc' => 'פארשליסט אויטאמאטיש די וויקי דאטנבאזע ווען אלע סיסאפן זענען אומאקטיוו פאר א געוויסער צייט.',
);
